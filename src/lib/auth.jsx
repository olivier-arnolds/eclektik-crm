...
export function AuthProvider({ children }) {
  ...
  async function login() {
    ...
    const { error } = await supabase.auth.signInWithOAuth({
      provider: 'azure',
      options: {
        scopes: 'email profile openid User.Read Mail.Read Mail.Send Calendars.Read Chat.Read ChatMessage.Read Team.ReadBasic.All Channel.ReadBasic.All ChannelMessage.Read.All',
