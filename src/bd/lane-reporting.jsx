...
export function computeMetrics(opps, companies, links, teamContacts, cfg) {
  ...
  // FX correction note: how much the weighted forecast shifted by converting
  // USD/GBP open deals to EUR (vs treating the raw number as euros).
  const fxOpen = openP.filter((o) => curOf(o.currency) !== 'EUR');
  const fxRaw = fxOpen.reduce((s, o) => s + (num(o.est_revenue) || 0) * (num(o.probability) || 0) / 100, 0);
